...
public class TestNode {
	...
	public static void main(String[] args) {
		Puzzle p = new Puzzle();
		p.readInput("C:\\Users\\Lenovo\\Downloads\\Lab 5_8Puzzle\\txt\\PuzzleMap.txt", 
				"C:\\Users\\Lenovo\\Downloads\\Lab 5_8Puzzle\\txt\\PuzzleGoalState.txt");
...
//		System.out.println(p.getGoalState());
		Node re = p.moveWhiteTile(initialState, 'l');
//
